    ...
    <section id="stats" className="px-3 py-6 md:px-6 md:py-10 bg-[#0a0f0b]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-3 mt-4">
        {[
          ...
          <div key={label} className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-widest text-[13px] text-white [font-family:var(--font-family-mono)]">
              {label}
            </span>
          </div>
        ))}
      ...
      {gh && lc ? (
        ...
        <div className="flex items-center justify-center py-20">
          <p className="text-[13px] text-[#4a9a5a] [font-family:var(--font-family-mono)]">
            $ loading --stats _
          </p>
        </div>
      )}
