...
// Only styles that Tailwind cannot express are kept here:
// 1. The devicon CDN font-face import
// 2. The dot-grid background-image (arbitrary value syntax is too verbose)
// 3. The physics-driven `transform` (set inline via JS anyway)
// 4. The `pointer-events` + `touch-action` combo on the arena
const MINIMAL_CSS = `
  @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@700;800&family=JetBrains+Mono:wght@400;500&display=swap');
